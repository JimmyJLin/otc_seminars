...
function addOneSeminar(req, res, next) {
  db.none('INSERT INTO Class (class_category, class_type, class_date, class_attendee, class_completed) VALUES ($1, $2, $3, $4, $5);', [req.body.params, req.body.seminar, req.body.date, 0, false])
    .then((data) => {
